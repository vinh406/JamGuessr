...
import { History, MusicNote, ChevronRight } from "../components/ui/icons";
                ...
                <div className="flex items-center gap-4">
                  {game.playlist?.imageUrl ? (
                    ...
                    <div className="w-14 h-14 rounded-lg bg-gray-700/50 shrink-0 flex items-center justify-center">
                      <MusicNote className="w-6 h-6 text-gray-500" />
                    </div>
                  )}
                  ...
                  <ChevronRight className="w-5 h-5 text-gray-500 shrink-0 group-hover:text-gray-300 transition-colors" />
                </div>
              </button>
            ))}
          </div>
