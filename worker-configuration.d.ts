/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a46e09f8e0527aaabe7d3e0ac27d656)
// Runtime types generated with workerd@1.20260609.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
  ...
  WEBSOCKET_HIBERNATION_SERVER: DurableObjectNamespace<
    import("./src/worker/index").WebSocketHibernationServer
  >;
  PLAYLIST_IMPORT_DO: DurableObjectNamespace<import("./src/worker/index").PlaylistImportDO>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker/index");
    durableNamespaces: "WebSocketHibernationServer" | "PlaylistImportDO";
  }
